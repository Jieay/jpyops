...
function ChangeAppActice(){

	var urlhrf = window.location.href;
	var limun = $('#appchg li').length;
	for (i=0;i<limun;i++){
		//console.log(i);
		var gtul = $('#appchg li a')[i].href
		if (urlhrf == gtul){
			$('#appchg li').siblings('li').removeClass('active');
			$('#appchg li a').parent()[i].className = "active";
			break;
		}
	}
